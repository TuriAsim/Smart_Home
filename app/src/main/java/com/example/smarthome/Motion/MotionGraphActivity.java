...
public class MotionGraphActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Motion Sensors Graph");
        toolbar.setTitleTextColor(Color.WHITE);
        setSupportActionBar(toolbar);

        txtname=findViewById(R.id.title);
        graphList= MotionActivity.motionlist;
        ...
        if (intent.equals("bath"))
        {
            ...
            txtname.setText("Motion bathroom Sensor Graph");

        }
        else if (intent.equals("bed"))
        {
            //graphList=  IlluminanceActivity.illlist;
            txtname.setText("Motion bedroom Sensor Graph");

        }
        else if (intent.equals("study"))
        {
            /// graphList=  IlluminanceActivity.illlist;
            txtname.setText("Motion study room Sensor Graph");
        ...
        {
            //graphList=  IlluminanceActivity.illlist;
            txtname.setText("Motion Living room-1 Sensor Graph");
        ...
        else if (intent.equals("live2"))
        {
            ...
            txtname.setText("Motion Living room-2 Sensor Graph");
        ...
        {
            // graphList= TemperatureActivity.templist;
            txtname.setText("Motion Kitchen Sensor Graph");
        ...
        if (graphList.size() != 0) {
            ...
            Toast.makeText(MotionGraphActivity.this,"No data found",Toast.LENGTH_SHORT).show();
        }
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(MotionGraphActivity.this, SubMotionActivity.class));
                finish();
            }
        });
    ...
    public void showGraph(){
        ...
        barLeftAxis.setAxisMaximum(260);
        barLeftAxis.setAxisMinimum(0);
        barLeftAxis.setGranularity(10f);
        barLeftAxis.setLabelCount(15);
        ...
        Toast.makeText(MotionGraphActivity.this, "Graph Data", Toast.LENGTH_SHORT).show();
