...
public class TemperatureGraphActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Temperature Sensors Graph");
       ...
       Log.e("temlist is","templist call");
        if (intent.equals("bath"))
        {
            //graphList= IlluminanceActivity.illlist;
            txtname.setText("Temperature bathroom Sensor Graph");

        }
        else if (intent.equals("bed"))
        {
            //graphList=  IlluminanceActivity.illlist;
            txtname.setText("Temperature bedroom Sensor Graph");

        }
        else if (intent.equals("study"))
        {
            /// graphList=  IlluminanceActivity.illlist;
            txtname.setText("Temperature study room Sensor Graph");
        ...
        {
            //graphList=  IlluminanceActivity.illlist;
            txtname.setText("Temperature Living room-1 Sensor Graph");
        ...
        {
            //  graphList= TemperatureActivity.templist;
            txtname.setText("Temperature Living room-2 Sensor Graph");
        ...
        {
            // graphList= TemperatureActivity.templist;
            txtname.setText("Temperature Kitchen Sensor Graph");
        ...
        if (graphList.size() != 0) {
            ...
            Toast.makeText(TemperatureGraphActivity.this,"No data found",Toast.LENGTH_SHORT).show();
        }
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(TemperatureGraphActivity.this, SubPowerActivity.class));
                finish();
            }
        });
    ...
    public void showGraph(){
        ...
        Toast.makeText(TemperatureGraphActivity.this, "Graph Data", Toast.LENGTH_SHORT).show();
