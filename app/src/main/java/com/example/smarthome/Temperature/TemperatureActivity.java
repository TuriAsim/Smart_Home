...
public class TemperatureActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public static List<Model> templist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tlistview=findViewById(R.id.templistview);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.txt_fromdate:
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(TemperatureActivity.this, new DatePickerDialog.OnDateSetListener() {
            ...
            case R.id.txt_todate:
                ...
                DatePickerDialog datePickerDialog2 = new DatePickerDialog(TemperatureActivity.this, new DatePickerDialog.OnDateSetListener() {
            ...
            case R.id.txt_totime:
                ...
                TimePickerDialog totime = new TimePickerDialog(TemperatureActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
            ...
            case R.id.btn_graph:
                ...
                Intent intentg=new Intent(TemperatureActivity.this, TemperatureGraphActivity.class);
    ...
    public  class TempClass extends AsyncTask<Void,Void,String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pD = new ProgressDialog(TemperatureActivity.this);
        ...
        protected void onPostExecute(String s) {
            ...
            if (s.equals("1")) {
                MotionAdapter mAdapter = new MotionAdapter(TemperatureActivity.this, templist);
                tlistview.setAdapter(mAdapter);
                pD.dismiss();
            }
            else if (s.equals("2")){

                Toast.makeText(TemperatureActivity.this,"From and TO datetime is not correct",Toast.LENGTH_SHORT).show();
                pD.dismiss();
            }
            else if (templist.size()<1){

                Toast.makeText(TemperatureActivity.this,"No Data Found",Toast.LENGTH_SHORT).show();
                pD.dismiss();
            }
        }
    }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        this.fileList();
        startActivity(new Intent(TemperatureActivity.this, SubTemperatureActivity.class));
    }
