...
public class DailyActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.txt_fromdate:
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(DailyActivity.this, new DatePickerDialog.OnDateSetListener() {
            ...
            case R.id.txt_todate:
                ...
                DatePickerDialog datePickerDialog2 = new DatePickerDialog(DailyActivity.this, new DatePickerDialog.OnDateSetListener() {
            ...
            case R.id.txt_totime:
                ...
                hour = calendar.get(Calendar.HOUR_OF_DAY);
                minute = calendar.get(Calendar.MINUTE);
                TimePickerDialog totime = new TimePickerDialog(DailyActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
            ...
            case R.id.btn_graph:
                ...
                Intent intentg=new Intent(DailyActivity.this, DailyActivityGraph.class);
    ...
    public  class IlluminanceClass extends AsyncTask<Void,Void,String> {
                ...
                if (response == 200) {
                    ...
                    for(int i=0; i<jsonArray.length();i++){
                        ...
                        JSONObject jsonObject = jsonArray.getJSONObject(i);
                           ...
                           /* if (fun_id.equals("43216") || fun_id.equals("43231") || fun_id.equals("43201") || fun_id.equals("41275")
                            || fun_id.equals("40750") || fun_id.equals("43186")) {
                                value = jsonObject.getString("value");
                                if (!value.equals("0")){
        ...
        protected void onPostExecute(String s) {
            ...
            if (s.equals("1")) {
                MotionAdapter mAdapter = new MotionAdapter(DailyActivity.this, illlist);
                ...
                Toast.makeText(DailyActivity.this,"From and TO datetime is not correct",Toast.LENGTH_SHORT).show();
                pD.dismiss();
            }
            else {

                Toast.makeText(DailyActivity.this,"No Data Found",Toast.LENGTH_SHORT).show();
                pD.dismiss();
            }
        }
    }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        this.fileList();
        startActivity(new Intent(DailyActivity.this, SensorsTypeActivity.class));
    }
