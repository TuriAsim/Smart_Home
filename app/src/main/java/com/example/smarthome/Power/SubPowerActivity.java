...
public class SubPowerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sub_power);

        toolbar= findViewById(R.id.toolbar);
        toolbar.setTitle("Power SubSensors");
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            /*case R.id.btn_bathroom:
                Intent bath= new Intent(SubPowerActivity.this, PowerActivity.class);
            ...
            case R.id.btn_bedroom:
                ...
                Intent bed= new Intent(SubPowerActivity.this,PowerActivity.class);
                bed.putExtra("ID","bed");
                startActivity(bed);
                this.finish();
            ...
            case R.id.btn_studyroom:
                ...
                Intent study= new Intent(SubPowerActivity.this,PowerActivity.class);
            ...
            case R.id.btn_liveroom_1:
                ...
                Intent live1= new Intent(SubPowerActivity.this,PowerActivity.class);
            ...
            case R.id.btn_liveroom_2:
                ...
                Intent live2= new Intent(SubPowerActivity.this,PowerActivity.class);
            ...
            case R.id.btn_kitchen:
                ...
                Intent kitchen= new Intent(SubPowerActivity.this,PowerActivity.class);
    ...
    public  class PowerClass extends AsyncTask<Void,Void,String> {
        ...
        String message="";
        String fun_id;
        int bedvalue,studyvalue,live1value,live2value,kitchenvalue;

        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            pD = new ProgressDialog(SubPowerActivity.this);
        ...
        protected void onPostExecute(String s) {
            ...
            if (s.equals("1")) {
                ...
                Toast.makeText(SubPowerActivity.this,"No Data Found",Toast.LENGTH_SHORT).show();
                pD.dismiss();
            }
        }
    }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(SubPowerActivity.this, MainActivity.class));
        this.finish();
    }
}
