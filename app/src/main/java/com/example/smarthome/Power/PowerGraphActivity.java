...
public class PowerGraphActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Power Sensors Graph");
        toolbar.setTitleTextColor(Color.WHITE);
        setSupportActionBar(toolbar);

        txtname=findViewById(R.id.title);
        graphList= PowerActivity.powerlist;
        ...
        if (intent.equals("bath"))
        {
            ...
            txtname.setText("Power bathroom Sensor Graph");

        }
        else if (intent.equals("bed"))
        {
            //graphList=  IlluminanceActivity.illlist;
            txtname.setText("Power bedroom Sensor Graph");

        }
        else if (intent.equals("study"))
        {
            /// graphList=  IlluminanceActivity.illlist;
            txtname.setText("Power study room Sensor Graph");
        ...
        {
            //graphList=  IlluminanceActivity.illlist;
            txtname.setText("Power Living room-1 Sensor Graph");
        ...
        else if (intent.equals("live2"))
        {
            ...
            txtname.setText("Power Living room-2 Sensor Graph");
        ...
        {
            // graphList= TemperatureActivity.templist;
            txtname.setText("Power Kitchen Sensor Graph");
       ...
       // Log.e("graph listsize",""+graphList.size());
        if (graphList.size() != 0) {
            ...
            Toast.makeText(PowerGraphActivity.this,"No data found",Toast.LENGTH_SHORT).show();
        }

        ok.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PowerGraphActivity.this, SubPowerActivity.class));
    ...
    public void showGraph(){
        ...
        Toast.makeText(PowerGraphActivity.this, "Graph Data", Toast.LENGTH_SHORT).show();
    }
